...
try {
    ...
    // Query videos with "TVC Covers" category
    $stmt = $pdo->prepare("
        ...
        WHERE c.name = 'TVC Covers' AND yv.status = 'active'
        ORDER BY yv.title
    ");
    $stmt->execute();
...
<head>
    ...
    <title>TVC Covers - TVC Twitch Song List</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <?php elseif (empty($videos)): ?>
            <p class="no-videos">No videos found in TVC Covers category.</p>
        <?php else: ?>
