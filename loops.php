...
try {
    ...
    // Query videos with "TVC Loops" category
    $stmt = $pdo->prepare("
        ...
        WHERE c.name = 'TVC Loops' AND yv.status = 'active'
        ORDER BY yv.title
    ");
    $stmt->execute();
...
<head>
    ...
    <title>TVC Loops - TVC Twitch Song List</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <?php elseif (empty($videos)): ?>
            <p class="no-videos">No videos found in TVC Loops category.</p>
        <?php else: ?>
